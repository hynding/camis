...
export const vectors: Vector[] = [
  ...
  {
    name: "ne equal false",
    expr: { kind: "ne", left: lit(1), right: lit(1) },
    data: {},
    expect: { ok: true, value: false },
  },
  {
  ...
  {
    name: "lte false",
    expr: { kind: "lte", left: lit(3), right: lit(2) },
    data: {},
    expect: { ok: true, value: false },
  },
  {
    name: "gte false",
    expr: { kind: "gte", left: lit(1), right: lit(2) },
    data: {},
    expect: { ok: true, value: false },
  },
  {
    name: "or all false",
    expr: { kind: "or", args: [lit(false), lit(false)] },
    data: {},
    expect: { ok: true, value: false },
  },
  {
    name: "or type mismatch",
    expr: { kind: "or", args: [lit(false), lit(1)] },
    data: {},
    expect: { ok: false, error: "TYPE_MISMATCH" },
  },
  {
    name: "not false",
    expr: { kind: "not", arg: lit(false) },
    data: {},
    expect: { ok: true, value: true },
  },
  {
    name: "not type mismatch",
    expr: { kind: "not", arg: lit(1) },
    data: {},
    expect: { ok: false, error: "TYPE_MISMATCH" },
  },
  {
    name: "isNull false",
    expr: { kind: "call", fn: "isNull", args: [lit(1)] },
    data: {},
    expect: { ok: true, value: false },
  },
  {
    name: "coalesce first non-null",
    expr: { kind: "call", fn: "coalesce", args: [lit(5), lit(9)] },
    data: {},
    expect: { ok: true, value: 5 },
  },
  {
    name: "coalesce all null",
    expr: { kind: "call", fn: "coalesce", args: [lit(null), lit(null)] },
    data: {},
